...
namespace ImGui
{
    ...
    IMGUI_API bool          Tab(const char* icon, const char* tabname, int* tab, int number, int total_tabs, float total_region_width, float alpha);
    // button
    ...
    IMGUI_API bool          Checkbox(const char* label, const char* description, bool* v);
