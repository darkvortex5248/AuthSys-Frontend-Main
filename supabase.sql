-- AuthSys Complete Database Schema for Supabase
-- এই SQL ফাইলটি Supabase PostgreSQL ডাটাবেসের জন্য সম্পূর্ণ স্কিমা
...
-- ============================================
-- ১০. RLS (Row Level Security) সেটআপ (Supabase এর জন্য)
-- ============================================

-- এন্ড ইউজার টেবিলের জন্য RLS
...
CREATE POLICY "App can create users"
...
-- লাইসেন্স কি টেবিলের জন্য RLS
ALTER TABLE license_keys ENABLE ROW LEVEL SECURITY;

CREATE POLICY "App can view its keys"
    ON license_keys FOR SELECT
    USING (true);

CREATE POLICY "App can create keys"
    ON license_keys FOR INSERT
    WITH CHECK (true);

-- অ্যাক্টিভিটি লগ টেবিলের জন্য RLS
ALTER TABLE activity_logs ENABLE ROW LEVEL SECURITY;

CREATE POLICY "App can view its logs"
    ON activity_logs FOR SELECT
    USING (true);

CREATE POLICY "App can create logs"
