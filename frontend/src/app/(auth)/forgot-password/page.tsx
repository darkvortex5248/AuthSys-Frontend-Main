...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="w-full max-w-[440px] bg-[var(--card)] p-[24px] rounded-xl border border-white/5 flex flex-col items-center transition-[background-color,box-shadow,border-color] duration-200 ease-out 0 shadow-2xl">
      ...
      <form onSubmit={handleSubmit} className="w-full space-y-6">
        <div className="space-y-2">
          ...
          <div className="relative group rounded focus-within:shadow-[0_0_12px_color-mix(in_srgb,var(--primary)_13%,transparent)] transition-[background-color,box-shadow,border-color] duration-200 ease-out">
            ...
            <input 
              className="w-full h-[42px] bg-[var(--card)] border border-[rgba(255,255,255,0.05)] rounded text-[13.5px] text-[#ffffff] placeholder-[#3f3f46] pl-10 focus:ring-0 focus:outline-none focus:border-[var(--primary)] transition-[background-color,box-shadow,border-color] duration-200 ease-out" 
              id="email" 
