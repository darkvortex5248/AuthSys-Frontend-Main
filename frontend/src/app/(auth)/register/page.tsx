...
export default function RegisterPage() {
  ...
  return (
    <div className={`w-full max-w-[400px] bg-[var(--card)] rounded-xl border border-white/5 p-8 flex flex-col gap-8 shadow-2xl transition-[background-color,box-shadow,border-color] duration-200 ease-out ${hasError ? 'animate-[shake_0.4s_cubic-bezier(.36,.07,.19,.97)_both] !border-[#ef4444] !shadow-[0_0_12px_rgba(239,68,68,0.2)]' : ''} ${isSuccess ? '!border-[#10b981] !shadow-[0_0_12px_rgba(16,185,129,0.3)]' : ''}`}>
      {/* Tab Switcher */}
      <div className="flex p-1 bg-[var(--background)] rounded-full border border-white/5 relative">
        <div className="absolute top-1 bottom-1 right-1 w-[calc(50%-4px)] bg-[var(--card)] rounded-full transition-[background-color,box-shadow,border-color] duration-200 ease-out ease-in-out" style={{ transform: 'translateX(0%)' }}></div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        <div className="space-y-2">
          ...
          <div className="relative group rounded-lg border border-white/5 bg-[var(--card)] transition-[background-color,box-shadow,border-color] duration-200 ease-out focus-within:border-[var(--primary)] focus-within:shadow-[0_0_12px_color-mix(in_srgb,var(--primary)_13%,transparent)]">
        ...
        <button 
          ...
          className={`w-full h-[42px] text-[13.5px] font-medium rounded-lg flex items-center justify-center gap-2 transition-[background-color,box-shadow,border-color] duration-200 ease-out active:brightness-95
            ${isSuccess 
        ...
        <div className="grid grid-cols-4 gap-2 sm:gap-3">
          <button onClick={() => handleSocialSignIn('google')} type="button" className="h-[42px] bg-[var(--card)] border border-white/5 0 rounded-lg flex items-center justify-center transition-[background-color,box-shadow,border-color] duration-200 ease-out group">
          ...
          <button onClick={() => handleSocialSignIn('discord')} type="button" className="h-[42px] bg-[var(--card)] border border-white/5 0 rounded-lg flex items-center justify-center transition-[background-color,box-shadow,border-color] duration-200 ease-out group">
          ...
          <button onClick={() => handleSocialSignIn('azure')} type="button" className="h-[42px] bg-[var(--card)] border border-white/5 0 rounded-lg flex items-center justify-center transition-[background-color,box-shadow,border-color] duration-200 ease-out group">
          ...
          <button onClick={() => handleSocialSignIn('github')} type="button" className="h-[42px] bg-[var(--card)] border border-white/5 0 rounded-lg flex items-center justify-center transition-[background-color,box-shadow,border-color] duration-200 ease-out group">
