...
export default function RegisterPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await api.post('/developer/auth/register', {
  ...
  return (
    <div className={`w-full max-w-[400px] bg-[#201f1f] rounded-xl border border-white/5 p-8 flex flex-col gap-8 shadow-2xl transition-all duration-300 ${hasError ? 'animate-[shake_0.4s_cubic-bezier(.36,.07,.19,.97)_both] !border-[#ffb4ab] !shadow-[0_0_12px_rgba(255,180,171,0.2)]' : ''} ${isSuccess ? '!border-[#5edac7] !shadow-[0_0_12px_rgba(94,218,199,0.3)]' : ''}`}>
      ...
      <div className="flex p-1 bg-[#0e0e0e] rounded-full border border-white/5 relative">
        <div className="absolute top-1 bottom-1 right-1 w-[calc(50%-4px)] bg-[#2a2a2a] rounded-full transition-all duration-300 ease-in-out" style={{ transform: 'translateX(0%)' }}></div>
        <Link href="/login" className="relative flex-1 py-2 text-[13.5px] font-medium leading-[1] text-center text-[#c8c6c5] z-10 transition-colors">Sign in</Link>
        <Link href="/register" className="relative flex-1 py-2 text-[13.5px] font-medium leading-[1] text-center text-[#e5e2e1] z-10 transition-colors">Sign up</Link>
      </div>
      ...
      <header className="flex flex-col items-center text-center gap-4">
        ...
        <div className="space-y-1">
          <h1 className="text-[20px] font-semibold leading-[28px] tracking-[-0.01em] text-[#e5e2e1]">Create Account</h1>
          <p className="text-[13.5px] font-normal leading-[20px] text-[#c8c6c5]">Join AuthSys today</p>
        </div>
      </header>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        <div className="space-y-2">
          <label className="text-[10.5px] font-medium leading-[16px] tracking-[0.07em] text-[#c8c6c5] uppercase">Email</label>
          <div className="relative group rounded-lg border border-white/5 bg-[#212121] transition-all duration-200 focus-within:border-[#d97757] focus-within:shadow-[0_0_12px_rgba(217,119,87,0.13)]">
            <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#c8c6c5] text-[20px] group-focus-within:text-[#d97757] transition-colors">mail</span>
            <input 
              id="email"
              type="email" 
        ...
        <div className="space-y-2">
          <label className="text-[10.5px] font-medium leading-[16px] tracking-[0.07em] text-[#c8c6c5] uppercase">Username</label>
          <div className="relative group rounded-lg border border-white/5 bg-[#212121] transition-all duration-200 focus-within:border-[#d97757] focus-within:shadow-[0_0_12px_rgba(217,119,87,0.13)]">
        ...
        <div className="space-y-2">
          <label className="text-[10.5px] font-medium leading-[16px] tracking-[0.07em] text-[#c8c6c5] uppercase">Confirm Password</label>
          <div className="relative group rounded-lg border border-white/5 bg-[#212121] transition-all duration-200 focus-within:border-[#d97757] focus-within:shadow-[0_0_12px_rgba(217,119,87,0.13)]">
            <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#c8c6c5] text-[20px] group-focus-within:text-[#d97757] transition-colors">lock_clock</span>
            <input 
              id="confirm_password"
