  ...
  return (
    <DashboardLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <Card className="bg-zinc-900 border-zinc-800 shadow-md hover:border-indigo-500/50 transition-colors">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-zinc-400">Total API Events Logged</CardTitle>
            <div className="p-2 bg-indigo-900/30 rounded-lg"><Activity className="h-4 w-4 text-indigo-400" /></div>
          </CardHeader>
          <CardContent>
