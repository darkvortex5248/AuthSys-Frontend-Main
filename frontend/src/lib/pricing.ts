...
export const DEFAULT_PLANS: Plan[] = [
  {
    ...
    has_ip_tracking: false, has_location_tracking: false, has_user_panel: false,
    has_staff_management: false, has_discord_integration: false, has_telegram_integration: false,
    has_api_access: false, has_custom_domain: false, has_live_chat: false,
    has_audit_logs: false, has_webhooks: false, has_white_label: false,
