...
module.exports = {
    ...
    async execute(interaction) {
        ...
        interaction.editReply({ embeds: [new EmbedBuilder().setTitle('Successfully set discord webhook to log commands to').setColor(Colors.Green).setTimestamp().setFooter({ text: "AuthSys Discord Bot" })], ephemeral: ephemeral })
