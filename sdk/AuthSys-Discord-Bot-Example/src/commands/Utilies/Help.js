...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      .setTitle(`AuthSys help menu`)
      .addFields([
        { name: '_ _', value: 'This bot is for the open-source authentication system [AuthSys](https://authsys.app)\n\nIf you\'re using the cloud hosted version of AuthSys, you\'ll need the seller plan to use. You can test before purchase by using the demo seller account in the #demo-accounts channel of the [Discord server](https://discord.gg/authsys)' },
        { name: 'Source code:', value: `[https://github.com/RinoxAuth/AuthSys-Discord-Bot](https://github.com/RinoxAuth/AuthSys-Discord-Bot)` },
