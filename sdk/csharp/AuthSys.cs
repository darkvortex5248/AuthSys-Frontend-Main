...
namespace AuthSysSDK
{
    ...
    public class AuthSys
    {
        ...
        /// <summary>Application Secret Key (64-char hex from dashboard).</summary>
        public string AppSecret { get { return _appSecret; } }

        /// <summary>Owner ID (short ID from dashboard).</summary>
        public string OwnerId { get { return _ownerId; } }

        /// <summary>App version sent to the API.</summary>
        public string Version { get { return _version; } }

        /// <summary>API base URL.</summary>
        public string BaseUrl { get { return _baseUrl; } }

        /// <summary>Session token after successful login.</summary>
        public string SessionToken { get { return _sessionToken; } }

        /// <summary>Hardware ID for this machine.</summary>
        public string Hwid { get; private set; }

        /// <summary>
        /// 3-arg constructor: appSecret, version, baseUrl.
        /// </summary>
        ...
        /// <summary>
        /// 4-arg constructor matching website layout:
        /// new AuthSys(appSecret, ownerId, version, baseUrl)
        /// </summary>
        ...
        /// <summary>Register a new user with a license key.</summary>
        ...
        /// <summary>Login with a license key only (no username/password needed).</summary>
        ...
        /// <summary>Check if a license key is valid without logging in.</summary>
        ...
        /// <summary>Verify the current session token is still valid.</summary>
        ...
        private async Task<JsonElement> PostAsync(string path, Dictionary<string, object> payload)
        {
            ...
            {
                return ToJson(new { success = false, message = "Request timed out. The server may be starting up — try again in a few seconds." });
            }
            catch (Exception ex)
            {
        ...
        private static async Task<JsonElement> ParseResponse(HttpResponseMessage response)
        {
            ...
            try
            {
                using (var doc = JsonDocument.Parse(body))
                {
                    ...
                    // Init endpoint returns { status, message, ... } without "success"
